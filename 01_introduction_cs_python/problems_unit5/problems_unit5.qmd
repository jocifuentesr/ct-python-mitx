...
class Message:
    def __init__(self, text):
        ...
        self.valid_words = list(string.ascii_lowercase)
    ...
    def build_shift_dict(self, shift):
        ...
        for i in range(len(lowercase_letters)):
            shift_dict[lowercase_letters[i]] = lowercase_letters[(i + shift) % len(lowercase_letters)]
            shift_dict[uppercase_letters[i]] = uppercase_letters[(i + shift) % len(uppercase_letters)]
...
def decrypt_story():
    ...
    shift_value, decrypted_story = ciphertext.decrypt_message()
    return shift_value, decrypted_story
```