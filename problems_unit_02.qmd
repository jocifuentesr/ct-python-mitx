...
while balance > 0:
    balanceCopy = balance
    monthlyPayment = lowestPayment
    for i in range(12):
        unpaidBalance = balanceCopy - monthlyPayment
        balanceCopy = unpaidBalance + monthlyInterestRate*unpaidBalance
...
while True:
    ...
    for i in range(12):
        unpaidBalance = balanceCopy - monthlyPayment
        balanceCopy = unpaidBalance + monthlyInterestRate*unpaidBalance
    if round(balanceCopy, 2) > 0:
        lowerBound = monthlyPayment
    elif round(balanceCopy, 2) < 0: 
